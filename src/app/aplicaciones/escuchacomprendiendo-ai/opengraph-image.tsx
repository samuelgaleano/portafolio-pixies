...
export const alt = 'escuchacomprendiendo.IA — de audio a decisiones citadas';
export const size = OG_SIZE;
export const contentType = 'image/png';

export default function OgImage() {
  return new ImageResponse(
    <OgCard eyebrow={t.escucha.appEyebrow} title="escuchacomprendiendo.IA" subtitle={escuchaProduct.tagline} titleSize={64} />,
    size
  );
}
