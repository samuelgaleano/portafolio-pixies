...
// Mejora progresiva: SSR muestra todos los logs y etapas (fallback estático legible);
// con JS + movimiento permitido, reproduce la secuencia. reduced-motion → estático.
