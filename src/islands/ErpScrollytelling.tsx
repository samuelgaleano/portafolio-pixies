...
// Recorrido guiado del ERP (§12.A). Mejora progresiva: el SSR ya trae todos los pasos
// legibles; el JS añade el panel sticky que sigue al scroll. Sin JS = secuencia estática.
