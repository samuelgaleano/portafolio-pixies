...
//
// Orden vertical (Samuel, 2026-09-22): marca → eslogan → CTA → **los dos accesos, debajo
// del logo**. Antes los accesos iban a los flancos del wordmark y se sentían encima y
// saturados; ahora bajan a una fila propia, compacta y centrada, con Creative a la
// izquierda y Web a la derecha (la gramática espacial se mantiene dentro de la fila).
  ...
  return (
    <section id="inicio" className="grid-bg relative overflow-hidden">
      ...
      <div className="grupo-hero relative z-10 mx-auto w-full max-w-[1200px] px-4 sm:px-6">
        ...
        {/* los dos accesos, debajo del logo: Creative a la izquierda, Web a la derecha */}
        <div className="grupo-hero__accesos hero-in" style={{ '--d': '0.6s' } as React.CSSProperties}>
          <Link href="/marketing" data-glyph-host className="acceso acceso--creative">
          ...
          <Link href="/web" data-glyph-host className="acceso acceso--web">
