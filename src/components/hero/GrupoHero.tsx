...
//
// Composición (Samuel, 2026-09-22): la marca al CENTRO y los dos accesos como recuadros en
// los COSTADOS — los espacios que quedaban vacíos a izquierda y derecha del wordmark, que
// Samuel marcó en rojo sobre la captura. Creative a la izquierda, Web a la derecha (la
// gramática espacial de siempre). Son compactos a propósito: el detalle de cada división
// vive en la bifurcación de abajo, aquí solo se entra.
  ...
  return (
    <section id="inicio" className="grid-bg relative overflow-hidden">
      ...
      <div className="grupo-hero relative z-10 mx-auto w-full max-w-[1500px] px-4 sm:px-6">
        {/* IZQUIERDA: Creative, en el costado que quedaba vacío (Samuel, 2026-09-22) */}
        <Link href="/marketing" data-glyph-host className="acceso acceso--creative hero-in" style={{ '--d': '0.6s' } as React.CSSProperties}>
        ...
        <div className="grupo-hero__marca">
          ...
          <div className="hero-in mt-5 flex flex-col items-center gap-2" style={{ '--d': '0.5s' } as React.CSSProperties}>
        ...
        {/* DERECHA: Web */}
        <Link href="/web" data-glyph-host className="acceso acceso--web hero-in" style={{ '--d': '0.6s' } as React.CSSProperties}>
